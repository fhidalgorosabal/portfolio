...
export const BUTTON_VARIANTS: Record<ButtonVariant, string> = {
  primary:
    "bg-sky-700 text-white hover:bg-sky-700 focus:ring-sky-500 " +
    "dark:bg-sky-500 dark:text-white dark:hover:bg-sky-400 dark:focus:ring-sky-300",
  secondary:
    "bg-slate-700 text-white hover:bg-slate-600 focus:ring-slate-500 " +
    "dark:bg-slate-500 dark:text-slate-200 dark:hover:bg-slate-600 dark:focus:ring-slate-400",
  success:
  ...
  outline:
    "border border-white text-white hover:bg-white focus:ring-white " +
